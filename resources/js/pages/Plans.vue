    ...
    <AppLayout>
            <section class="bg-white py-12">
                <div class="w-full justify-center text-center">
                    <h1 class="font-bold text-black text-2xl">Choose a Plan</h1> 
                    <!-- text-gboprimary-600 -->
                    <h5 class="text-gbosecondary-500">Partner with us to share your insights, gain visibility.</h5>
                </div>
                ...
                <div>
                    ...
                    <Link :href="route('basic-plan')" class="w-full py-3.5 inline-block text-center bg-gboprimary-600 hover:bg-gboprimary-700 text-white py-2 rounded-full">Subscribe</Link>
                </div>
                </div>
                ...
                <div>
                    ...
                    <Link :href="route('premium-plan')" class="w-full inline-block text-center bg-gboprimary-600 hover:bg-gboprimary-700 text-white py-3.5 rounded-full">Subscribe</Link>
                </div>
                </div>
                </div>
            </section>
